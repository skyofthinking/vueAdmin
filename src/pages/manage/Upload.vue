<template>
    <section>
        <el-form ref="form" :model="form" @submit.prevent="onSubmit" style="margin:10px;">
            ...
            <el-upload action="/api/posts/" type="drag" :thumbnail-mode="true" :on-preview="handlePreview" :on-remove="handleRemove"
            ...
            <vue-core-image-upload :class="['pure-button','pure-button-primary','js-btn-crop']" :crop="true" text="上传图片" url="/api/posts/"
                extensions="png,gif,jpeg,jpg" @:imageuploaded="imageuploaded" @:errorhandle="handleError"></vue-core-image-upload>
            </div>
        </el-form>
    </section>
</template>
